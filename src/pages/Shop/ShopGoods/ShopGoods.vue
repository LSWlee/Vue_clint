...
<script type="text/javascript">
  ...
  export default {
    data(){
      return  {
        scrollY:0,//右侧Y轴滑动的时候====>左侧不断改变，
        tops:[],//右侧分类li的top值===>初始统计一次，不会改变
        food:{},
      }
    },
    mounted(){
    ...
    computed:{
      ...
      const index = tops.findIndex((top, index) => {
        ...
        //保存新产生的index ------leftScroll初始显示是没有的currentIndex初始显示就会调用
