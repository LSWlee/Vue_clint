    ...
    <div class="ratings-content">
      <div class="overview">
        <div class="overview-left">
          ...
          <div class="title">综合评分{{info.serviceScore}}</div>
      ...
      <RatingSelect :SelectType="SelectType" :onlyContent="onlyContent"
            ...
            @setSelectType="setSelectType" @toggleContent="toggleContent"/>
        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="time">{{rating.rateTime | data-format('HH:mm:ss')}}</div>
            </div>
          </li>
        </ul>
      </div>
    ...
    computed:{
      ...
      filterRatings(){
       ...
       return ratings.filter((rating)=>{
          ...
          return (rateType===2 || rateType===SelectType) && (!onlyContent || text.length>0)
       })
      }
    },
    methods:{
