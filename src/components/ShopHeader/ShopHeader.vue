  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="showContent=true">
    ...
    <div class="shop-header-discounts" @click="showDiscounts=true">
    ...
    <transition name="showContentAnm">
      <div class="shop-brief-modal" v-if="showContent">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="showContent=false">
    ...
    <div class="activity-sheet" v-if="showDiscounts">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="discountsColor[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
  ...
  export default {
    data(){
      return{
        showContent:false,
        showDiscounts:false,
        discountsColor:['activity-green','activity-red','activity-orange']
      }
    },
    computed:{
      ...mapState({
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  ...
  .shop-header
    ...
    .shop-brief-modal
      ...
      color #333
      &.showContentAnm-enter-active,&.showContentAnm-leave-active
        transition opacity .5s
      &.showContentAnm-enter, &.showContentAnm-leave-to
        opacity 0
      .brief-modal-cover
        position absolute
        width 100%
